...
## Навігація та управління (2.1.198)

| Скорочення | Виправлення | Версія |
|-----------|-------------|--------|
| Mac keyboard hints over SSH | Keyboard shortcut hints тепер показують opt/cmd замість alt/super при з'єднанні з Mac через SSH | 2.1.198 |

## Голосовий режим (2.1.200)

| Скорочення | Виправлення | Версія |
|-----------|-------------|--------|
| Voice dictation misleading error fix | Виправлено оманливе повідомлення "Voice connection failed" коли recording не містить аудіо | 2.1.200 |

## Навігація та управління (2.1.200)

| Скорочення | Виправлення | Версія |
|-----------|-------------|--------|
| Screen-reader output improvements | Покращено screen-reader output: декоративні символи приховані, транскрипт-символи читаються як короткі мітки, вкладені таблиці як `Header: value.` | 2.1.200 |

## Навігація та управління (2.1.203)
