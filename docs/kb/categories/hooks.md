...
## Налаштування хуків (2.1.195)

| Можливість | Опис | Версія |
|-----------|------|--------|
| Hyphenated identifiers exact-match fix | Виправлено hook matchers з дефісованими ідентифікаторами (напр. `code-reviewer`, `mcp__brave-search`) що випадково substring-matching; тепер точний збіг. Для wildcard по всім інструментам hyphenated MCP сервера використовуйте `mcp__brave-search__.*` | 2.1.195 |

## Налаштування хуків (2.1.191)
