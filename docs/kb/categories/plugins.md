...
| Можливість | Опис | Версія |
|-----------|------|--------|
| Plugin auto-rename marketplace `renames` | Marketplace `renames` maps тепер слідуються автоматично — оновлює ваші налаштування до нової назви плагіна | 2.1.193 |
...
| Можливість | Опис | Версія |
|-----------|------|--------|
| Plugin LSP server fail isolation fix | Виправлено плагінний LSP server що не стартував та блокував інший валідний LSP server від іншого плагіна для того ж розширення файлу | 2.1.205 |
