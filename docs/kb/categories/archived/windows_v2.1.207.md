...
> Попередні версії: [rotated/windows_v2.1.202.md](rotated/windows_v2.1.202.md), [rotated/windows_v2.1.206.md](rotated/windows_v2.1.206.md), [rotated/windows_v2.1.207.md](rotated/windows_v2.1.207.md)
...
| Agents view keyboard input fix [Win] | Виправлено ігнорування вводу з клавіатури у agents view коли setup prompt з'являвся перед bare `claude --resume` на Windows | 2.1.206 |
